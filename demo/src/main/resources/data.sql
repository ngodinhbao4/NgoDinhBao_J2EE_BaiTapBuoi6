...
INSERT INTO account (login_name, password) SELECT 'user', '$2b$12$jdPdtRJ0Uy4gKLGGQWORZOpsA5gra0dUthvqenosbcKVXLmFQMI6u' WHERE NOT EXISTS (SELECT 1 FROM account WHERE login_name = 'user1');
